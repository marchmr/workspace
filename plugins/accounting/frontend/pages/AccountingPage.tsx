...
export default function AccountingPage({ sessionToken }: AccountingPageProps) {
    ...
    return (
        ...
        <div className="kp-acc-shell">
            {/* Kundendaten */}
            {customer && (
                <div className="kp-acc-customer-card">
                    <div className="kp-acc-customer-head">
                        <h2 className="kp-acc-customer-title">Kundendaten</h2>
                        <span className="kp-acc-customer-kind">
                            {customer.kind === 'person' ? 'Person' : 'Firma'}
                        </span>
                    </div>
                    <div className="kp-acc-customer-grid">
                        <section className="kp-acc-customer-pane">
                            <h3 className="kp-acc-pane-title">Stammdaten</h3>
                            <div className="kp-acc-field-list">
                                <div className="kp-acc-field-row">
                                    <span className="kp-acc-field-label">Name</span>
                                    <span className="kp-acc-field-value">{displayValue(customer.name)}</span>
                                </div>
                                <div className="kp-acc-field-row">
                                    <span className="kp-acc-field-label">Kundennummer</span>
                                    <span className="kp-acc-field-value">{displayValue(customer.customerNumber)}</span>
                                </div>
                                <div className="kp-acc-field-row">
                                    <span className="kp-acc-field-label">Ansprechperson</span>
                                    <span className="kp-acc-field-value">{displayValue(customer.contactPerson)}</span>
                                </div>
                            </div>
                        </section>

                        <section className="kp-acc-customer-pane">
                            <h3 className="kp-acc-pane-title">Kontakt</h3>
                            <div className="kp-acc-field-list">
                                <div className="kp-acc-field-row">
                                    <span className="kp-acc-field-label">E-Mail</span>
                                    <span className="kp-acc-field-value kp-acc-field-break">{displayValue(customer.email)}</span>
                                </div>
                                <div className="kp-acc-field-row">
                                    <span className="kp-acc-field-label">Adresse</span>
                                    <span className="kp-acc-field-value kp-acc-field-break">{displayValue(customer.address)}</span>
                                </div>
                            </div>
                        </section>
                    </div>
